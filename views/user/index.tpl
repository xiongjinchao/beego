...
<div class="row">
    <div class="col-xs-12">
    	<p><a href="#" class="btn btn-success"><i class="fa fa-plus-circle"></i> 创建用户</a></p>
		<div class="box">
			...
			<div class="box-body">
			  ...
			  <table id="example1" class="table table-bordered table-striped table-hover dataTable" role="grid" aria-describedby="example2_info">
			    <thead>
