    ...
    <div class="register-box-body">
        ...
        <form id="user" action="/register" method="post">
            ...
            <div class="form-group has-feedback {{if .errors.name}} has-error {{end}}">
                <input type="text" name="name" class="form-control" placeholder="Full name" value="admin">
                <span class="glyphicon glyphicon-user form-control-feedback"></span>
                {{if .errors.name}}
                    <p class="help-block help-block-error">{{.errors.name}}</p>
                {{end}}
            </div>
            <div class="form-group has-feedback {{if .errors.email}} has-error {{end}}">
                <input type="email" name="email" class="form-control" placeholder="Email" value="xiongjinchao@hotmail.com">
